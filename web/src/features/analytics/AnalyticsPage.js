...
const COLORS = ["#4F46E5", "#0284C7", "#38BDF8", "#818CF8", "#3730A3", "#67E8F9"];
const GRID = "#E2E8F0";
const AXIS = "#5B6B80";
...
export function AnalyticsPage() {
    ...
    return (_jsxs("div", { className: "mx-auto max-w-7xl space-y-6", children: [_jsxs("div", { children: [_jsx("h1", { className: "font-display text-2xl font-semibold text-ink", children: "Analytics" }), _jsx("p", { className: "mt-1 text-sm text-ink-soft", children: "Organization-level meeting trends. Descriptive insights, not performance scores." })] }), _jsxs("div", { className: "grid gap-6 lg:grid-cols-2", children: [_jsx(ChartCard, { title: "Meetings per month", children: _jsxs(BarChart, { data: months(data.meetings_per_month), children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: GRID, vertical: false }), _jsx(XAxis, { dataKey: "label", tick: { fill: AXIS, fontSize: 12 }, axisLine: false, tickLine: false }), _jsx(YAxis, { tick: { fill: AXIS, fontSize: 12 }, axisLine: false, tickLine: false, allowDecimals: false }), _jsx(Tooltip, { contentStyle: tooltipStyle, cursor: { fill: "#EEF2FF" } }), _jsx(Bar, { dataKey: "value", fill: "#4F46E5", radius: [6, 6, 0, 0], maxBarSize: 28 })] }) }), _jsx(ChartCard, { title: "Meeting hours per month", children: _jsxs(LineChart, { data: months(data.meeting_hours_per_month), children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: GRID, vertical: false }), _jsx(XAxis, { dataKey: "label", tick: { fill: AXIS, fontSize: 12 }, axisLine: false, tickLine: false }), _jsx(YAxis, { tick: { fill: AXIS, fontSize: 12 }, axisLine: false, tickLine: false }), _jsx(Tooltip, { contentStyle: tooltipStyle }), _jsx(Line, { type: "monotone", dataKey: "value", stroke: "#0284C7", strokeWidth: 2.5, dot: { r: 3 } })] }) }), _jsx(ChartCard, { title: "Action item completion", children: _jsxs(PieChart, { children: [_jsx(Pie, { data: data.action_item_completion, dataKey: "value", nameKey: "label", innerRadius: 55, outerRadius: 90, paddingAngle: 3, children: data.action_item_completion.map((_, i) => (_jsx(Cell, { fill: [COLORS[0], COLORS[2], "#F59E0B"][i % 3] }, i))) }), _jsx(Tooltip, { contentStyle: tooltipStyle })] }) }), _jsx(ChartCard, { title: "Decisions per month", children: _jsxs(BarChart, { data: months(data.decisions_per_month), children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: GRID, vertical: false }), _jsx(XAxis, { dataKey: "label", tick: { fill: AXIS, fontSize: 12 }, axisLine: false, tickLine: false }), _jsx(YAxis, { tick: { fill: AXIS, fontSize: 12 }, axisLine: false, tickLine: false, allowDecimals: false }), _jsx(Tooltip, { contentStyle: tooltipStyle, cursor: { fill: "#EFF6FF" } }), _jsx(Bar, { dataKey: "value", fill: "#0284C7", radius: [6, 6, 0, 0], maxBarSize: 28 })] }) }), _jsx(ChartCard, { title: "Meetings by department", children: _jsxs(BarChart, { data: data.meetings_by_department, layout: "vertical", children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: GRID, horizontal: false }), _jsx(XAxis, { type: "number", tick: { fill: AXIS, fontSize: 12 }, axisLine: false, tickLine: false, allowDecimals: false }), _jsx(YAxis, { type: "category", dataKey: "label", tick: { fill: AXIS, fontSize: 12 }, axisLine: false, tickLine: false, width: 90 }), _jsx(Tooltip, { contentStyle: tooltipStyle, cursor: { fill: "#EEF2FF" } }), _jsx(Bar, { dataKey: "value", fill: "#818CF8", radius: [0, 6, 6, 0], maxBarSize: 22 })] }) }), _jsx(ChartCard, { title: "Language usage", children: _jsxs(PieChart, { children: [_jsx(Pie, { data: data.language_usage, dataKey: "value", nameKey: "label", outerRadius: 90, paddingAngle: 3, children: data.language_usage.map((_, i) => (_jsx(Cell, { fill: COLORS[i % COLORS.length] }, i))) }), _jsx(Tooltip, { contentStyle: tooltipStyle })] }) })] })] }));
}
